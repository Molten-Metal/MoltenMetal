		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.AIR.asItem()) {
			if (new Object() {
				...
				if (entity instanceof LivingEntity _entity) {
					ItemStack _setstack = new ItemStack(MoltenmetalModItems.HOT_IRON_AXE_BLADE.get());
				...
				if (entity instanceof LivingEntity _entity) {
					ItemStack _setstack = new ItemStack(MoltenmetalModItems.HOT_GOLDEN_AXE_BLADE.get());
					_setstack.setCount(1);
					_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
					if (_entity instanceof Player _player)
						_player.getInventory().setChanged();
				...
				if (entity instanceof LivingEntity _entity) {
					ItemStack _setstack = new ItemStack(MoltenmetalModItems.HOT_DIAMOND_AXE_BLADE.get());
					_setstack.setCount(1);
					_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
					if (_entity instanceof Player _player)
						_player.getInventory().setChanged();
